...
export interface IMetricEntityAttributes extends IModelAttributes {
	name: string;
	description: string;
...
export default class MetricEntity extends Model implements IMetricEntityAttributes {
	...
	constructor(attributes?: Partial<IMetricEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IMetricEntityAttributes>) {
...
CRUD(createdAttr)(MetricEntity.prototype, 'created');
CRUD(modifiedAttr)(MetricEntity.prototype, 'modified');
