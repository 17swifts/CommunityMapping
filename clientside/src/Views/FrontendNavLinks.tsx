...
export function getFrontendNavLinks(pageProps: RouteComponentProps): ILink[][] {
	...
	return [
		...
		[
			...
			{label: "Service Profile", path: '/serviceprofile', icon: "roadmap", iconPos: 'icon-left', subLinks: [{label: "Service Profile", path: '/serviceprofile', icon: "raodmap", iconPos: 'icon-left'},{label: "Service  Dashboard", path: '/servicedashboard', icon: "chart-pie", iconPos: 'icon-left'},{label: "All Services", path: '/services', icon: "actions", iconPos: 'icon-left'}]},
