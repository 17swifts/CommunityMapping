...
@observer
export default class RegionalAreaTimelineEventsEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.RegionalAreaTimelineEventsEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
