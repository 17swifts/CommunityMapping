...
namespace APITests.EntityObjects.Models
{
	public class MetricEntity : BaseEntity
	{
		...
		public MetricEntity()
		{
			EntityName = "MetricEntity";
			InitialiseReferences();
		}

		public MetricEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<MetricEntity>()
		...
		public static MetricEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<MetricEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static MetricEntity GetValidEntity(string fixedStrValue = null)
		{
			var metricEntity = new MetricEntity
			{
			};
			metricEntity.PopulateAttributes();
