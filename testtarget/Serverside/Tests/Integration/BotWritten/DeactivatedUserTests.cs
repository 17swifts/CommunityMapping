...
namespace ServersideTests.Tests.Integration.BotWritten
{
	...
	public class DeactivatedUserTests
	{
		...
		{
			await CreateAndValidateUser<ServiceCommissioningBodyEntity>();
		}
		// % protected region % [Customize CreateAndValidateUser Test for ServiceCommissioningBodyEntity] end
		...
		public static TheoryData<User> DeactivatedUserTheoryData() {
			...
			{
				new AdminEntity(),
				new ServiceCommissioningBodyEntity(),
			};
		}
