...
namespace ServersideTests.Tests.Integration.BotWritten.GroupSecurityTests.Delete
{
	...
	public class ServiceCommissioningBodyDeleteTest : BaseDeleteTest
	{
		public ServiceCommissioningBodyDeleteTest()
		{
			// % protected region % [Add constructor logic here] off begin
			// % protected region % [Add constructor logic here] end
		}

		public static TheoryData<IAbstractModel, string, string> DeleteServiceCommissioningBodySecurityData =>
		...
		[Theory]
		[MemberData(nameof(DeleteServiceCommissioningBodySecurityData))]
		public async Task ServiceCommissioningBodyDeleteSecurity<T>(T model, string message, string groupName)
