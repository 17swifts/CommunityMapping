...
{
	public class CrudServiceEntityPage : Page
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/serviceEntity";
		...
		public ServiceEntityCrudList CrudList => new(By.CssSelector("section.collection__list"), ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CrudServiceEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
