...
{
	public class ServiceEntityCrudListRow : Component, ICrudListRow
	{
		...
		public ServiceEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
