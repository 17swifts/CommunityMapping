...
{
	public class MetricEntityCrudListRow : Component, ICrudListRow
	{
		...
		public MetricEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
