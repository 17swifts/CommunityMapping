...
{
	public class CrudMetricEntityPage : Page
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/metricEntity";
		...
		public MetricEntityCrudList CrudList => new(By.CssSelector("section.collection__list"), ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CrudMetricEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
