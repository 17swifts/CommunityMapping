...
{
	public class RegionalAreaEntityCrudListRow : Component, ICrudListRow
	{
		...
		public RegionalAreaEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
