...
{
	public class CrudRegionalAreaEntityPage : Page
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/regionalAreaEntity";
		...
		public RegionalAreaEntityCrudList CrudList => new(By.CssSelector("section.collection__list"), ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CrudRegionalAreaEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
