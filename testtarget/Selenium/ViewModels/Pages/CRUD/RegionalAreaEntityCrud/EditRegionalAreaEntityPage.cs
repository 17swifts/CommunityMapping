...
{
	public class EditRegionalAreaEntityPage : RegionalAreaEntityAttributeCollection
	{
		...
		public EditRegionalAreaEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
