...
{
	public class CrudServiceCommissioningBodyEntityPage : Page
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/serviceCommissioningBodyEntity";
		...
		public ServiceCommissioningBodyEntityCrudList CrudList => new(By.CssSelector("section.collection__list"), ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CrudServiceCommissioningBodyEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
