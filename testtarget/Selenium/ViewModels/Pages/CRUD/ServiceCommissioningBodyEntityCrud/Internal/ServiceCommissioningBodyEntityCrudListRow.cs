...
{
	public class ServiceCommissioningBodyEntityCrudListRow : Component, ICrudListRow
	{
		...
		public ServiceCommissioningBodyEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
