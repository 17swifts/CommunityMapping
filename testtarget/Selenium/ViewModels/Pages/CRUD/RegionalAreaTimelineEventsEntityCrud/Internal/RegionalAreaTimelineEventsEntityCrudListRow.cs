...
{
	public class RegionalAreaTimelineEventsEntityCrudListRow : Component, ICrudListRow
	{
		...
		public RegionalAreaTimelineEventsEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
