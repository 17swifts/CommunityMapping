...
Feature: Admin Submenu RegionalAreaEntity

	@RegionalAreaEntity
	Scenario: Admin Submenu RegionalAreaEntity
	...
	And I click the Regional area admin submenu
	Then I assert that I am on the Regional area Entity backend page