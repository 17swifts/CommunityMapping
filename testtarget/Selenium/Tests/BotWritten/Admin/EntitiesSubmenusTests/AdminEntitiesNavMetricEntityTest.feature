...
Feature: Admin Submenu MetricEntity

	@MetricEntity
	Scenario: Admin Submenu MetricEntity
	...
	And I click the Metric admin submenu
	Then I assert that I am on the Metric Entity backend page