...
Feature: Admin Submenu ServiceEntity

	@ServiceEntity
	Scenario: Admin Submenu ServiceEntity
	...
	And I click the Service admin submenu
	Then I assert that I am on the Service Entity backend page