...
@BotWritten @Filter
Feature: MetricEntity filtered by today's modified Feature

@MetricEntity
Scenario: MetricEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid MetricEntity entities
And I navigate to the MetricEntity backend page
When I click the filter Button on the MetricEntity page
