...
@BotWritten @Filter
Feature: ServiceCommissioningBodyEntity filtered by today's modified Feature

@ServiceCommissioningBodyEntity
Scenario: ServiceCommissioningBodyEntity filtered by today's modified
...
When I click the filter Button on the ServiceCommissioningBodyEntity page
