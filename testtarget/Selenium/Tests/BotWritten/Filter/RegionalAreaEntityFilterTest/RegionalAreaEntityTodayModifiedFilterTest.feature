...
@BotWritten @Filter
Feature: RegionalAreaEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@RegionalAreaEntity
Scenario: RegionalAreaEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid RegionalAreaEntity entities
And I navigate to the RegionalAreaEntity backend page
When I click the filter Button on the RegionalAreaEntity page
