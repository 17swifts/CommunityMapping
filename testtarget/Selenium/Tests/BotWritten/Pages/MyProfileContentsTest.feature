...
@BotWritten @pages
Feature: MyProfilePage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@MyProfilePage
Scenario: Check contents of MyProfilePage page
Given I login to the site as a user
And I navigate to the MyProfilePage frontend page
Then The contents of the MyProfilePage is correct
