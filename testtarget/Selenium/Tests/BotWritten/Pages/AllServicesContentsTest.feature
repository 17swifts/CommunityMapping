...
@BotWritten @pages
Feature: AllServicesPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@AllServicesPage
Scenario: Check contents of AllServicesPage page
Given I login to the site as a user
And I navigate to the AllServicesPage frontend page
Then The contents of the AllServicesPage is correct
