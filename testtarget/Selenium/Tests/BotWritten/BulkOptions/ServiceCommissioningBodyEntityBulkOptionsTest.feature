...
Feature: ServiceCommissioningBodyEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@ServiceCommissioningBodyEntity
Scenario: Select all ServiceCommissioningBodyEntitys on current page
...
@ServiceCommissioningBodyEntity
Scenario: I attempt to select all ServiceCommissioningBodyEntitys on all pages
Given I login to the site as a user
And I navigate to the ServiceCommissioningBodyEntity backend page
When I select all entities on current page
