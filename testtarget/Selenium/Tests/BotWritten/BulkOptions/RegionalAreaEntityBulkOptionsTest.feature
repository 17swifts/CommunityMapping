...
Feature: RegionalAreaEntity Bulk Option Selection
...
@RegionalAreaEntity
Scenario: Select all RegionalAreaEntitys on current page
...
@RegionalAreaEntity
Scenario: I attempt to select all RegionalAreaEntitys on all pages
Given I login to the site as a user
And I navigate to the RegionalAreaEntity backend page
When I select all entities on current page
