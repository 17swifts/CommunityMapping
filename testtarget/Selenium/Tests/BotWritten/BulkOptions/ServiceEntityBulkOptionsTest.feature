...
Feature: ServiceEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@ServiceEntity
Scenario: Select all ServiceEntitys on current page
...
@ServiceEntity
Scenario: I attempt to select all ServiceEntitys on all pages
Given I login to the site as a user
And I navigate to the ServiceEntity backend page
When I select all entities on current page
