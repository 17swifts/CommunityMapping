...
Feature: MetricEntity Bulk Option Selection
...
@MetricEntity
Scenario: Select all MetricEntitys on current page
...
@MetricEntity
Scenario: I attempt to select all MetricEntitys on all pages
Given I login to the site as a user
And I navigate to the MetricEntity backend page
When I select all entities on current page
