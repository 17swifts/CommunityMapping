...
{
	public class RegisterServiceCommissioningBodyEntityUserPage : RegisterUserBasePage
	{
		public override string Url => baseUrl + "/login";

		public RegisterServiceCommissioningBodyEntityUserPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
