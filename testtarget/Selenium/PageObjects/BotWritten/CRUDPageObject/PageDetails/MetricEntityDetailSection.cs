...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class MetricEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		public MetricEntityDetailSection(ContextConfiguration contextConfiguration, MetricEntity metricEntity = null) : base(contextConfiguration)
		{
		...
		public void Apply()
		{
			...
			SetName(_metricEntity.Name);
			SetDescription(_metricEntity.Description);
