...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class RegionalAreaTimelineEventsEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly RegionalAreaTimelineEventsEntity _regionalAreaTimelineEventsEntity;
		...
		public RegionalAreaTimelineEventsEntityDetailSection(ContextConfiguration contextConfiguration, RegionalAreaTimelineEventsEntity regionalAreaTimelineEventsEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_regionalAreaTimelineEventsEntity = regionalAreaTimelineEventsEntity;
		...
		private By GetErrorAttributeSectionAsBy(string attribute)
		{
			return attribute switch
			{
				...
				"ActionTitle" => WebElementUtils.GetElementAsBy(SelectorPathType.CSS, "div.actionTitle > div > p"),
				"Description" => WebElementUtils.GetElementAsBy(SelectorPathType.CSS, "div.description > div > p"),
				"GroupId" => WebElementUtils.GetElementAsBy(SelectorPathType.CSS, "div.groupId > div > p"),
		...
		public void Apply()
		{
			...
			SetAction(_regionalAreaTimelineEventsEntity.Action);
			SetActionTitle(_regionalAreaTimelineEventsEntity.ActionTitle);
			SetDescription(_regionalAreaTimelineEventsEntity.Description);
			SetGroupId(_regionalAreaTimelineEventsEntity.GroupId);
