...
namespace SeleniumTests.Steps.BotWritten.Pages
{
	...
	public sealed class PagesSteps  : BaseStepDefinition
	{
		...
		private UIModeledPage GetPage(string page)
		{
			return page switch
			{
				"ServiceProfilePage" => new ServiceProfilePage(_contextConfiguration),
				"CommunityProfilePage" => new CommunityProfilePage(_contextConfiguration),
				...
				"AllServicesPage" => new AllServicesPage(_contextConfiguration),
				"MyCommunityMappingPage" => new MyCommunityMappingPage(_contextConfiguration),
