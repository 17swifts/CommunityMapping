...
namespace Cis.Models
{
	...
	/// </summary>
	public class MetricEntityType : ObjectGraphType<MetricEntity>
	{
		public MetricEntityType()
		{
	...
	/// </summary>
	public class MetricEntityInputType : InputObjectGraphType<MetricEntity>
	{
		public MetricEntityInputType()
		{
			Name = "MetricEntityInput";
			Description = "The input object for adding a new MetricEntity";
