...
{
	public class MetricEntityDto : ModelDto<MetricEntity>
	{
		...
		public MetricEntityDto(MetricEntity model)
		{
			LoadModelData(model);
		...
		public override MetricEntity ToModel()
		{
		...
		public override ModelDto<MetricEntity> LoadModelData(MetricEntity model)
		{
			Id = model.Id;
