...
namespace Cis.Models
{
	...
	public class UploadFile : IAbstractModel
	{
		...
		/// <summary>
		/// Link to the ServiceCommissioningBody entity which contains a file on the ProfileImage attribute
		/// </summary>
#nullable enable
		public ServiceCommissioningBodyEntity? ServiceCommissioningBodyProfileImage { get; set; }
#nullable disable
