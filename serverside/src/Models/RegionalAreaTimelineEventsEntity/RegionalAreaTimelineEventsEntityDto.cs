...
namespace Cis.Models
{
	...
	/// </summary>
	public class RegionalAreaTimelineEventsEntityDto : ModelDto<RegionalAreaTimelineEventsEntity>
	{
		...
		public RegionalAreaTimelineEventsEntityDto(RegionalAreaTimelineEventsEntity model)
		{
			LoadModelData(model);
		...
		public RegionalAreaTimelineEventsEntityDto()
		{
		...
		public override ModelDto<RegionalAreaTimelineEventsEntity> LoadModelData(RegionalAreaTimelineEventsEntity model)
		{
			Id = model.Id;
