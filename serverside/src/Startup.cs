...
using Cis.Enums;
using Cis.Services.CertificateProvider;
...
namespace Cis
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			{
				options.InvalidModelStateResponseFactory = ctx => new CisActionResult();
			});
		...
		private void AddSwaggerService(IServiceCollection services)
		{
			...
			{
				options.SwaggerDoc("json", new OpenApiInfo {Title = "Cis", Version = "v1"});
		...
		private void ConfigureAuthServices(IServiceCollection services)
		{
			...
			services.AddDataProtection()
				.PersistKeysToDbContext<CisDBContext>();
		...
		private void ConfigureGraphql(IServiceCollection services)
		{
			...
			services.TryAddSingleton<RegionalAreaEntityType>();
			services.TryAddSingleton<RegionalAreaEntityInputType>();
			services.TryAddSingleton<ServiceEntityType>();
			services.TryAddSingleton<ServiceEntityInputType>();
			...
			services.TryAddSingleton<ISchema, CisSchema>();
			services.TryAddSingleton<CisQuery>();
			services.TryAddSingleton<CisMutation>();
			...
			IWebHostEnvironment env)
		{
			...
			{
				options.SwaggerEndpoint("/api/swagger/json/openapi.json", "Cis");
