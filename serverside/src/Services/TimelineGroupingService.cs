...
namespace Cis.Services
{
	public class TimelineGroupingService : ITimelineGroupingService
	{
		...
		public async Task<List<TimelineGroupDateQueryResult<T>>> MonthlyGroupingQuery<T>(TimelineFilter timelineFilter, int months) 
			where T : class, IOwnerAbstractModel, new()
		{
		...
		public async Task<List<TimelineGroupDateQueryResult<T>>> DailyGroupingQuery<T>(TimelineFilter timelineFilter, int days) 
			where T : class, IOwnerAbstractModel, new()
		{
			var baseQuery = GetBaseQuery<T>(timelineFilter);
			return await baseQuery
		...
		public async Task<List<TimelineGroupDateQueryResult<T>>> HourlyGroupingQuery<T>(TimelineFilter timelineFilter, int hours) 
			where T : class, IOwnerAbstractModel, new()
		{
			var baseQuery = GetBaseQuery<T>(timelineFilter);
			return await baseQuery
