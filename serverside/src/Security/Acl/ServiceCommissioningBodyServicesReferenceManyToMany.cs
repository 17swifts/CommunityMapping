...
{
	/// <summary>
	/// Security listing for the ServiceCommissioningBody group for the ServicesReferenceManyToMany scheme
	/// </summary>
	public class ServiceCommissioningBodyServicesReferenceManyToMany : IAcl
	{
