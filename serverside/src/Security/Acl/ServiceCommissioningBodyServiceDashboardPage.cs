...
{
	/// <summary>
	/// Security listing for the ServiceCommissioningBody group for the ServiceDashboardPage scheme
	/// </summary>
	public class ServiceCommissioningBodyServiceDashboardPage : IAcl
	{
