...
{
	/// <summary>
	/// Security listing for the ServiceCommissioningBody group for the ServiceCommissioningBodyEntity scheme
	/// </summary>
	public class ServiceCommissioningBodyServiceCommissioningBodyEntity : IAcl
	{
