...
{
	/// <summary>
	/// Security listing for the ServiceCommissioningBody group for the CommunityProfilePage scheme
	/// </summary>
	public class ServiceCommissioningBodyCommunityProfilePage : IAcl
	{
